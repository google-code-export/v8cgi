...
exports.md5 = function(input) {
	if (!(input instanceof Buffer)) { throw new TypeError("Input to md5 must be an instance of Buffer"); }
...
exports.sha1 = function(input) {
	if (!(input instanceof Buffer)) { throw new TypeError("Input to sha1 must be an instance of Buffer"); }
